(function () {
    ...
    var current_word_location = 0;
    function get_next_word() {
        if (current_word_location >= saved_words.length)
            current_word_location = 0;
        var word = saved_words[current_word_location][0];
        ++current_word_location;
        return word;
    }
    ...
    function start(delay, weight) {
        ...
        function _loop() {
            ...
            translator.translate(word, true, 500, function () {
